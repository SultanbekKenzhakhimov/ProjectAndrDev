...
class SingleMovie : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.sostoyanieSeti_peremennaya.observe(this, Observer {
            progress_bar.visibility = if (it == SostoyanieSeti.LOADING) View.VISIBLE else View.GONE
            txt_error.visibility = if (it == SostoyanieSeti.ERROR) View.VISIBLE else View.GONE
