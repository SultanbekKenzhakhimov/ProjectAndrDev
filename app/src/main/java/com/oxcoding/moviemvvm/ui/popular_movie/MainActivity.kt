...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.sostoyanieSeti_peremennaya.observe(this, Observer {
            progress_bar_popular.visibility = if (viewModel.listIsEmpty() && it == SostoyanieSeti.LOADING) View.VISIBLE else View.GONE
            txt_error_popular.visibility = if (viewModel.listIsEmpty() && it == SostoyanieSeti.ERROR) View.VISIBLE else View.GONE

            if (!viewModel.listIsEmpty()) {
                movieAdapter.setsostoyanieSeti_peremennaya(it)
            }
        })
